...
public class RedissonLockUtil {
	...
	public static RLock getQrTotalMoneyLock(String merchNo,String outChannel,String accountNo){
		return redissLock.getLock(RedisConstants.lock_qr_total_money + merchNo +
