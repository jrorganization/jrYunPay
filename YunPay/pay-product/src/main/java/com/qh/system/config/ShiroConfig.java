...
public class ShiroConfig {
	...
	public SessionManager sessionManager() {
		...
		//解决org.apache.shiro.session.UnknownSessionException: There is no session with id [xxxx]的问题
		//问题是因为在shiro的DefaultWebSessionManager类中，默认Cookie名称是JSESSIONID，这样的话与servlet容器名冲突,
	...
	static{
		...
		filterChainDefinitionMap.put("/pay/query/**", anon);
