...
public enum FeeType {
	...
	static {
        ...
        descMap.put(changeMoney.id, "修改金额");
...
//        merchDescMap.put(merchChargeHandFee.id, "");//descMap.get(merchChargeHandFee.id));
		...
		merchDescMap.put(changeMoney.id, "修改金额");
...
//        platDescMap.put(platChargeIn.id, "");//descMap.get(platChargeIn.id));
       /* platDescMap.put(withdrawOut.id, "");//descMap.get(withdrawOut.id));
        platDescMap.put(withdrawFail.id, "");//descMap.get(withdrawFail.id));
        platDescMap.put(withdrawNopass.id, "");//descMap.get(withdrawNopass.id));
        platDescMap.put(platWithDrawHandFee.id, "");//descMap.get(platWithDrawHandFee.id));
*/        
...
//		agentDescMap.put(withdrawNopass.id, "");//descMap.get(withdrawNopass.id));
		...
		agentDescMap.put(changeMoney.id, "修改金额");
	}
