...
public class ParamUtil {
	...
	public static int generateCode2() {
		return 10 + ThreadLocalRandom.current().nextInt(90);
	}
	...
	public static int generateCode8() {
		return 10000000 + ThreadLocalRandom.current().nextInt(90000000);
	}
	...
	public static double random2Point(int range) {
		return ThreadLocalRandom.current().nextInt(0, range * 100) / 100.0;
	}
	...
	public static double random2Point(int from, int to) {
		return ThreadLocalRandom.current().nextInt(from * 100, to * 100) / 100.0;
	}
