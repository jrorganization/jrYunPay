...
public interface MerchantService {
	...
	Map<String,String> getMerchantNameMap(Map<String, Object> map);
	...
	int updatePKey(String merchNo, String publicKey);

	void updatePrivateKey(String merchNo, String privateKey);

	String getPrivateKey(String merchNo);
}
