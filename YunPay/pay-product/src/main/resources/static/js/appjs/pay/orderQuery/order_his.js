	...
	$('#exampleTable').bootstrapTable({
		...
		columns : [
			...
			},
			{
				...
				title : '回调通知',
				formatter : function(value,row,index) {
					 if(noticeStates[value]== "回调中"){
					 	return '<a class="btn btn-primary " href=" #" mce_href="#" title="补单" onclick="des(\''+row.orderNo+'\')"><i class="fa fa-refresh"></i></ a> ';
					 }else{
					 	return "成功";
					 }
				}
...
function des(orderNo){
	$.ajax({
		type : "POST",
		url : "/pay/order/detection/"+orderNo,
		//async : true,
